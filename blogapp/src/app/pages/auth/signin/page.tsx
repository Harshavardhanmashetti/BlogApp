    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
     ...
     fetch(`${process.env.NEXT_PUBLIC_BACKEND_API}/auth/login`, {
            ...
            if (!res.ok) {
                ...
                const errorText = await res.text(); // Fallback to text for non-JSON responses
            ...
            <div className="left">
                ...
                <div className='right'>
                    ...
                    >
                        ...
                        <p className="authlink">Don`t have an account? <Link href="/pages/auth/signup">Register</Link>
                        </p>
                    </form>
                </div>
